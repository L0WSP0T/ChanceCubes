...
import chanceCubes.client.particles.QuestionParticles;
...
public class ClientHelper {
    ...
    public static void registerParticleFactories(final ParticleFactoryRegisterEvent event) {
        Minecraft.getInstance().particleEngine.register(ModParticles.QUESTION_PARTICLE.get(),
                QuestionParticles.Provider::new);
    }
